                            ...
                            Object.values(roomUsers).map((user: UserInfo) => (
                                <div key={user.uuid} className={`flex gap-2 items-center rounded-lg p-2 text-white truncate ${userData?.uuid == user.uuid ? 'bg-emerald-600' : 'bg-neutral-800' }`}>
                                    ...
                                    <div className='flex w-full gap-2'>
                                        ...
                                        <span className={`flex justify-center items-center h-5 px-2 rounded min-w-5 font-bold ${user?.role == 'gm' ? 'bg-yellow-500 text-yellow-900' : 'bg-neutral-100 text-neutral-700'}`}>
                                            {user?.role}
                                        </span>
                                    </div>
                                </div>
            ...
            <div className='flex flex-col justify-center p-4 gap-4'>
                    ...
                    <section className='flex flex-col gap-4 justify-center items-center w-full sm:w-1/2'>
                        ...
                        { socketUserData?.role == 'gm' ? (
                            <div className='flex items-end justify-end w-full gap-4'>
                                ...
                                >
                                    <MousePointerClick className='bg-blue-500 p-1 rounded-lg text-lg'/>Apply
                                </Button>
                            </div>    
                        ) : (
                            <span className='flex gap-2 items-center w-full text-white text-3xl'>
                        ...
                        <img src={roomData.location} alt='map-location' className='rounded-lg h-full'/>
                    </section>
                </div>
                ...
                <div className='flex flex-col gap-4 w-full sm:flex-row max-h-[400px]'>
                    ...
                    <section className='flex flex-col gap-4 justify-center items-center w-full sm:w-1/2'>
                        ...
                        <img src={roomData.showcase} alt='display-image' className='rounded-lg h-full'/>
                    </section>
