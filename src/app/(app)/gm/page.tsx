...
import { LogIn, CirclePlus, Plus, Dice5 } from "lucide-react";
            ...
            >
              ...
              <div className="flex w-full justify-center items-center">
                <div className="flex w-full bg-shade-3 p-2 rounded">
                  ...
                  <Dice5
                    ...
                    className="cursor-pointer text-foreground-1"
                  />
                </div>
              </div>
              ...
              <div className="flex w-full justify-end">
                <div className="flex gap-2 items-center">
                  <Link
                    href="/connect"
                    className="flex items-center justify-center text-shade-1 w-full bg-shade-4 hover:bg-shade-3 p-1 px-2 transition rounded-full gap-2"
                  >
        ...
        <div className="hidden lg:flex flex-col w-full justify-center items-center gap-2 lg:w-1/2">
          <span className="text-5xl text-foreground-1 font-bold text-center">
            ...
            <p className="text-sm italic text-foreground-4">
              {"Start an history with big adventures"}
            </p>
          </span>
        </div>
      </div>
