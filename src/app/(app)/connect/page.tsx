                ...
                <dialog className="fixed inset-0 z-10 flex items-center justify-center bg-transparent p-4">
                    <div className="w-full  p-6 bg-shade-5 rounded border border-shade-4 shadow-xl">
                        <div className='flex w-full justify-between'>
                            ...
                            <X className='w-8 h-8 text-foreground-4 hover:text-foreground-1 hover:scale-105 transition cursor-pointer' onClick={() => setModalOpen(false)}/>
                        </div>
                        
                        <div className="flex flex-col lg:flex-row gap-4 items-start p-2">

                            <a className="text-start w-full bg-transparent p-2 rounded-lg hover:bg-shade-4 hover:text-foreground-1 hover:scale-105 transition" href='/gm'>
                                <span className='text-2xl font-bold text-foreground-4'>Game Master</span>
                                <Alert  
                                    type="info" 
                                    title="Info"
                            ...
                            <a className="text-start w-full bg-transparent p-2 rounded-lg hover:bg-shade-4 hover:text-foreground-1 hover:scale-105 transition" href='/player'>
                                <span className='text-2xl font-bold text-foreground-4'>Player</span>
                                <Alert  
                                    type="info" 
                                    title="Info"
                    ...
                    <Form.Body onSubmit={onFormSubmit} schema={ZodSchema} style="w-full md:w-[500px] bg-shade-4">
                        ...
                        <div className="flex w-full justify-end">
                            <div className='flex gap-2 items-center'>
                                <span className='flex items-center justify-center text-shade-1 w-full bg-shade-4 hover:bg-shade-3 p-1 px-2 transition rounded-full gap-2 cursor-pointer' onClick={() => setModalOpen(true)}>
